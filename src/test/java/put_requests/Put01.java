...
public class Put01 extends JsonPlaceHolderBaseUrl {
    ...
    public void put01() {
        ...
        // map icin test datası olusturuyoruz test datamızın bır metodu olucak expectedData ıcın bır map dondurucek
    ...
    @Test//Dinamik Yöntem olusturdum test datadakı jsonplaceholdertestdata ya gore
    public void put01b() {
        //Set the URL
        spec.pathParams("first", "todos", "second", 198);
